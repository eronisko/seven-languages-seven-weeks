...
all_members([],_).	
all_members([Head|Tail], Range) :- member(Head, Range), all_members(Tail, Range).
...
sudoku(Puzzle, Solution) :-
	...
	fd_labeling(Solution). %http://blog.clome.info/posts/day-3-constraint-solving-in-prolog.html
